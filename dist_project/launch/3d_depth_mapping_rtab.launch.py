...
def generate_launch_description():
    ...
    remappings=[
        ('odom','/shelfino1/odom'),
          ('rgb/image', '/shelfino1/f_camera/image_raw'),
          ('rgb/camera_info', '/shelfino1/f_camera/camera_info'),
          ('depth/image', '/shelfino1/f_camera/depth/image_raw')]
